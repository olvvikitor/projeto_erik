...
<div class="content-box mt-3">
  <?= form_open_multipart('/stock/product/adicionar', ['id' => 'edit_stock', 'novalidate' => false]) ?>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group mt-5">
              <label for="inputEstado">Quantidade a ser adicionada</label>
            ...
            <div class="form-group mt-2">
              ...
              <input type="text" class="form-control" value="<?= 1 ?>" name="fornecedor" id="fornecedor">
              <?= display_errors('fornecedor', $validation_errors) ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <h4 class="mt-0 text-end">Estoque atual:</h4>
              <h1 class=" mb-1 text-end"><strong><?= $product->stock ?></strong></h1>
            </div>
          </div>
        </div>
      </div>
